...
class SimpleInputField extends StatefulWidget {
  ...
  const SimpleInputField({Key? key, required this.controller, required this.title, required this.hintText, this.iconData, this.inputType}) : super(key: key);
        ...
        TextFormField(
          ...
          validator: (value){
            if(value == null || value.isEmpty)
              {
                return "Pleas enter a valid entry";
              }
            return null;
          },
